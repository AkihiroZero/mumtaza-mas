...
Route::group(['middleware' => ['web', 'auth', 'verified']], function () {
    ...
    Route::resource('level', LevelEmasController::class)->only('index', 'store', 'update', 'destroy');
    Route::resource('kadar', KadarEmasController::class)->only('index', 'store', 'update', 'destroy');
    Route::resource('emas', EmasController::class)->only('index', 'store', 'update', 'destroy');
});
