        ...
        <div class="modal-content">
            <form action="{{ route('level.update', $level->id) }}" method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-edit-level-{{ $level->id }}-label">Edit Level
                        ({{ $level->name }})</h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="level Name"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="price" placeholder="level price"
                            name="price" value="{{ $level->price }}">
                        <x-form.validation.error name="price" />
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea type="text" class="form-control" id="description" placeholder="Permission description" name="description">{{ $level->description }}</textarea>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            ...
                            <input class="form-check-input code-switcher" type="checkbox" id="tables-small-showcode"
                                name="status" value="1" @checked($level->status)>
                        </div>
